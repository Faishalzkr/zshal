        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!isNumber(user.lastjudi)) user.lastrob = 0
                    if (!isNumber(user.lastrob)) user.lastron = 0
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, 'HY MEK', action === 'add' ? 'Jangan Dipencet🗿!' : 'Jangan Dipencet🗿!', action === 'add' ? 'huuu' : 'FokusID')
                        }
                    }
                }
                break
