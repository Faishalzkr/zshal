...
`.trim()  
        ...
        case 'anvered':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let _lm = `${Math.floor(Math.random() * 5000000)}`.trim()
                    let _le = `${Math.floor(Math.random() * 550000)}`.trim()
                    let _lp = `${Math.floor(Math.random() * 50000)}`.trim()
                    let _lu = `${Math.floor(Math.random() * 7000)}`.trim()
                    let _lc = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _ll = `${pickRandom(['0', '2', '1', '7'])}`.trim()
                    let _lpp = `${pickRandom(['2', '1', '0'])}`.trim()
                    let _ld = `${Math.floor(Math.random() * 5)}`.trim()
                    let _lmm = `${pickRandom(['0', '1', '0', '3', '6', '0'])}`.trim()
                    let lm = (_lm * 1)
                    let le = (_le * 1)
                    let lp = (_lp * 1) 
                    let lu = (_lu * 1) 
                    ...
                    let lmm = (_lmm * 1)
                    let Lechat = `
Anda telah membuka *Anvered crate* dan mendapatkan:${lm > 0 ? `\nMoney: ${lm}` : ''}${le > 0 ? `\nExp: ${le} *exp*` : ''}${ld > 0 ? `\nDiamond: ${ld} *diamond*` : ''}${lp > 0 ? `\nPotion: ${lp} *potion*` : ''}${lc > 0 ? `\nCommon crate: ${lc} *crate*` : ''}${lu > 0 ? `\nUncommon crate: ${lu} *crate*` : ''}
`.trim()  
                    if (global.db.data.users[m.sender].anvered >= 1) {
                        global.db.data.users[m.sender].anvered -= 1
                        global.db.data.users[m.sender].money += lm * 1
                        global.db.data.users[m.sender].diamond += ld * 1
                        global.db.data.users[m.sender].exp += le * 1
                        global.db.data.users[m.sender].potion += lp * 1
                    ...
                    } else conn.reply(m.chat, 'Anvered crate anda tidak cukup', m)
                    break
                case '10':
                    let _lm1 = `${Math.floor(Math.random() * 1000000)}`.trim()
                    let _le1 = `${Math.floor(Math.random() * 15000000)}`.trim()
                    let _lp1 = `${Math.floor(Math.random() * 300000)}`.trim()
                    let _lu1 = `${Math.floor(Math.random() * 5000000)}`.trim()
                    let _lc1 = `${Math.floor(Math.random() * 700005)}`.trim()
                    let _ll1 = `${Math.floor(Math.random() * 2000000)}`.trim()
                    let _lpp1 = `${Math.floor(Math.random() * 6000000)}`.trim()
                    let _ld1 = `${Math.floor(Math.random() * 160000)}`.trim()
                    let _lmm1 = `${Math.floor(Math.random() * 400000)}`.trim()
                    let lm1 = (_lm1 * 1)
                    let le1 = (_le1 * 1)
                    let lp1 = (_lp1 * 1) 
                    let lu1 = (_lu1 * 1) 
                    ...
                    let lmm1 = (_lmm1 * 1)
                    let Lechat1 = `
Anda telah membuka *Anvered crate* dan mendapatkan:${lm1 > 0 ? `\nMoney: ${lm1}` : ''}${le1 > 0 ? `\nExp: ${le1} *exp*` : ''}${ld1 > 0 ? `\nDiamond: ${ld1} *diamond*` : ''}${lp1 > 0 ? `\nPotion: ${lp1} *potion*` : ''}${lc1 > 0 ? `\nCommon crate: ${lc1} *crate*` : ''}${lu1 > 0 ? `\nUncommon crate: ${lu1} *crate*` : ''}
`.trim()  
                    if (global.db.data.users[m.sender].anvered >= 10) {
                        global.db.data.users[m.sender].anvered -= 10
                        global.db.data.users[m.sender].money += lm1 * 1
                        global.db.data.users[m.sender].diamond += ld1 * 1
                        global.db.data.users[m.sender].exp += le1 * 1
                        global.db.data.users[m.sender].potion += lp1 * 1
                    ...
                    break
                case '100':
                    let _lm2 = `${Math.floor(Math.random() * 100000000)}`.trim()
                    let _le2 = `${Math.floor(Math.random() * 200000000)}`.trim()
                    let _lp2 = `${Math.floor(Math.random() * 10000000)}`.trim()
                    let _lu2 = `${Math.floor(Math.random() * 250000000)}`.trim()
                    let _lc2 = `${Math.floor(Math.random() * 75000000)}`.trim()
                    let _ll2 = `${Math.floor(Math.random() * 1100000)}`.trim()
                    let _lpp2 = `${Math.floor(Math.random() * 5100000)}`.trim()
                    let _ld2 = `${Math.floor(Math.random() * 5000000)}`.trim()
                    let _lmm2 = `${Math.floor(Math.random() * 1100000)}`.trim()
                    let lm2 = (_lm2 * 1)
                    let le2 = (_le2 * 1)
                    let lp2 = (_lp2 * 1) 
                    let lu2 = (_lu2 * 1) 
                    ...
                    let lmm2 = (_lmm2 * 1)
                    let Lechat2 = `
Anda telah membuka *Anvered crate* dan mendapatkan:${lm2 > 0 ? `\nMoney: ${lm2}` : ''}${le2 > 0 ? `\nExp: ${le2} *exp*` : ''}${ld2 > 0 ? `\nDiamond: ${ld2} *diamond*` : ''}${lp2 > 0 ? `\nPotion: ${lp2} *potion*` : ''}${lc2 > 0 ? `\nCommon crate: ${lc2} *crate*` : ''}${lu2 > 0 ? `\nUncommon crate: ${lu2} *crate*` : ''}
`.trim()  
                    if (global.db.data.users[m.sender].anvered >= 100) {
                        global.db.data.users[m.sender].anvered -= 100
                        global.db.data.users[m.sender].money += lm2 * 1
                        global.db.data.users[m.sender].diamond += ld2 * 1
                        global.db.data.users[m.sender].exp += le2 * 1
                        global.db.data.users[m.sender].potion += lp2 * 1
                    ...
                    break
                case '1000':
                    let _lm3 = `${Math.floor(Math.random() * 2000000000)}`.trim()
                    let _le3 = `${Math.floor(Math.random() * 5000000000)}`.trim()
                    let _lp3 = `${Math.floor(Math.random() * 500000000)}`.trim()
                    let _lu3 = `${Math.floor(Math.random() * 1000000000)}`.trim()
                    let _lc3 = `${Math.floor(Math.random() * 250000000)}`.trim()
                    let _ll3 = `${Math.floor(Math.random() * 510000000)}`.trim()
                    let _lpp3 = `${Math.floor(Math.random() * 22200000)}`.trim()
                    let _ld3 = `${Math.floor(Math.random() * 25000000)}`.trim()
                    let _lmm3 = `${Math.floor(Math.random() * 111000000)}`.trim()
                    let lm3 = (_lm3 * 1)
                    let le3 = (_le3 * 1)
                    let lp3 = (_lp3 * 1) 
                    let lu3 = (_lu3 * 1) 
                    ...
                    let lmm3 = (_lmm3 * 1)
                    let Lechat3 = `
Anda telah membuka *Anvered crate* dan mendapatkan:${lm3 > 0 ? `\nMoney: ${lm3}` : ''}${le3 > 0 ? `\nExp: ${le3} *exp*` : ''}${ld3 > 0 ? `\nDiamond: ${ld3} *diamond*` : ''}${lp3 > 0 ? `\nPotion: ${lp3} *potion*` : ''}${lc3 > 0 ? `\nCommon crate: ${lc3} *crate*` : ''}${lu3 > 0 ? `\nUncommon crate: ${lu3} *crate*` : ''}
`.trim()  
                    if (global.db.data.users[m.sender].anvered >= 1000) {
                        global.db.data.users[m.sender].anvered -= 1000
                        global.db.data.users[m.sender].money += lm3 * 1
                        global.db.data.users[m.sender].diamond += ld3 * 1
                        global.db.data.users[m.sender].exp += le3 * 1
                        global.db.data.users[m.sender].potion += lp3 * 1
