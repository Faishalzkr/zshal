...
const Sdiamond = 15000
const Bcommon = 50000
const Scommon = 25000
const Suncommon = 250000
const Buncommon = 125000
const Bmythic = 750000
const Smythic = 450000
const Blegendary = 1250000
const Slegendary = 850000
const Banvered = 5000000
const Sanvered = 2500000
const Bsampah = 5000
const Ssampah = 5
const Bkayu = 2000
const Skayu = 1250
...
${rpg.emoticon('anvered')}Anvered         :  ${Banvered}
...
${rpg.emoticon('anvered')}Anvered         :  ${Sanvered}
                ...
                switch (_type) {
                    ...
                    case 'anvered':
                            if (global.db.data.users[m.sender].money >= Banvered * count) {
                                ...
                                conn.send2Button(m.chat, `Succes membeli ${count} ${rpg.emoticon('anvered')}Anvered dengan harga ${Banvered * count} ${rpg.emoticon('money')}Money`, wm, 'inventory', usedPrefix + 'inv', 'buka anvered crate', usedPrefix + 'open anvered', m)
                            } else conn.send2Button(m.chat, `Uang anda tidak cukup untuk membeli ${count} ${rpg.emoticon('anvered')}Anvered crate dengan harga ${Banvered * count} ${rpg.emoticon('money')}money\n\nBuka crate dengan ketik: *${usedPrefix}open anvered*`, wm, 'inventory', usedPrefix + 'inv', 'buka anvered crate', usedPrefix + 'open anvered', m)                                         
                        break
                    case 'sampah':
